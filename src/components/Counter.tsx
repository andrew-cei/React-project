...
export default function Counter() {
  ...
  return (
    <div className="max-w-md mx-auto p-8 my-10 bg-white rounded-lg shadow-sm">
      ...
      <div onClick={decrement} className="grid grid-cols-3 gap-3 mt-6">
        <button className="flex items-center justify-center py-3 px-4 bg-gray-100 hover:bg-gray-200 rounded-md transition-colors cursor-pointer">
